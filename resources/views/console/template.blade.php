...
@section('content')
            ...
            <div class="row placeholders mb-3">
                <div class="col-6 col-sm-3 placeholder text-center">
                    <img src="https://placehold.it/200/dddddd/fff?text=1" class="center-block img-fluid rounded-circle" alt="Generic placeholder thumbnail">
                    <h4>Responsive</h4>
                    <span class="text-muted">Device agnostic</span>
                </div>
                <div class="col-6 col-sm-3 placeholder text-center">
                    <img src="https://placehold.it/200/e4e4e4/fff?text=2" class="center-block img-fluid rounded-circle" alt="Generic placeholder thumbnail">
                    <h4>Frontend</h4>
                    <span class="text-muted">UI / UX oriented</span>
                </div>
                <div class="col-6 col-sm-3 placeholder text-center">
                    <img src="https://placehold.it/200/d6d6d6/fff?text=3" class="center-block img-fluid rounded-circle" alt="Generic placeholder thumbnail">
                    <h4>HTML5</h4>
                    <span class="text-muted">Standards-based</span>
                </div>
                <div class="col-6 col-sm-3 placeholder text-center">
                    <img src="https://placehold.it/200/e0e0e0/fff?text=4" class="center-block img-fluid rounded-circle" alt="Generic placeholder thumbnail">
                    <h4>Framework</h4>
            ...
            <div class="row mb-3">
                <div class="col-lg-3 col-md-4">
                    <div class="card">
                        <img class="card-img-top img-responsive" src="https://placehold.it/740x180/bbb/fff?text=..." alt="Card image cap">
            ...
            <div class="card-columns mb-3">
                <div class="card">
                    <img class="card-img-top img-responsive" src="https://placehold.it/600x200/444/fff?text=..." alt="Card image cap">
                    <div class="card-block">
                ...
                <div class="card">
                    <img class="card-img-top img-responsive" src="https://placehold.it/600x200/bbb/fff?text=..." alt="Card image cap">
                    <div class="card-block">
                        <h4 class="card-title">Card title</h4>
                ...
                <div class="card">
                    <img class="card-img img-responsive" src="https://placehold.it/600x200/777/fff?text=..." alt="Card image">
                </div>
                        ...
                        <div id="tabsJustifiedContent" class="tab-content">
                            ...
                            <div class="tab-pane active" id="tab2">
                                <div class="row">
                                    ...
                                    <div class="col-sm-5"><img src="https://placehold.it/170" class="float-right img-responsive img-rounded"></div>
                                </div>
                                <hr>
